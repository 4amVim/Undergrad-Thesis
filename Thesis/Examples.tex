...
\begin{definition}[$H^\bullet$ ] %{{{ $H^\bullet$ 		Definition
...
\begin{definition}[$H_A$ or $\mathcal{A} (\_,A)$  i.e. dual of $H^A$ ] %{{{ H_A i.e. dual of	Definition
...
\begin{definition}[Representation for contravariant functors] %{{{ Representation for contravariant functors		Definition
