...
\begin{document}
\section{Abstract}
This paper attempts to explain the interpretation of Yoneda Lemma as described in $CITE$.
		...
		\begin{proof} \setcounter{equation}{0} Let a group $G$ be given.
			...
			& \mathcal{A} (\star,\star)
				...
				\item\textbf{The collection $[\mathcal{A}^{op},Set](H_\star,H_\star)$ is a group.}
					...
					and hence, an element of $G$. Thus, every element of $G$ gives us
					at least one natural transformation.
					Hence, as $j^{-1} \in G$, there exists $\delta:H_\star \to H_\star$ such that
					$j^{-1}=\delta_\star(1_\star)$.	And as $\psi$ is a group
					isomorphism,
...
This gives us that $\delta$ and $\gamma$ are inverses, as
		...
		\mathcal{A} (\star,\star) \cong^\psi G .\qedhere \]
		\end{proof}
