	...
	& X(K)
		...
		\begin{proof} \setcounter{equation}{0} Let a group $G$ be given.
			...
			& \mathcal{A} (\star,\star)
					...
					That is because $\alpha_\star$ is a function to $\mathcal{A} (\star,\star)$ gives that
					$\alpha_\star(1_\star)\in \mathcal{A} (\star,\star)$.
				...
				\item\textbf{The collection $[\mathcal{A}^{op},Set](H_\star,H_\star)$ is a group.}
					...
					I gives us the existence of $j\in G$ such that
					...
					at $1_\star$, which is a morphism in $\mathcal{A}(\star,\star)$,
					and hence, an element of $G$. Thus, every element of $G$ gives us
					at least one natural transformation.
					Hence, there exists $\delta:H_\star \to H_\star$ such that
